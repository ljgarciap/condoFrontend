            ...
            <tr *ngFor="let person of people()" class="border-b border-gray-100 hover:bg-blue-50 transition-colors">
              ...
              <td class="py-4 px-6 text-center">
                <div class="flex justify-center gap-3">
                    ...
                    <button *ngIf="authService.isAdmin()" (click)="deletePerson(person.id)" class="text-red-500 hover:text-red-700 bg-red-50 hover:bg-red-100 p-2 rounded-lg transition-colors shadow-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
